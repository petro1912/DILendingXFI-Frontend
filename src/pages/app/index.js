...
import BalanceText from 'src/views/pages/home/BalanceText';
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
            <Box
              ...
              <Button
                ...
                aria-haspopup='true'
                onClick={handleClick}>
                <img src={`/images/tokens/${token}.png`} className='tokenImg' />
            ...
            {
              client && <Box sx={{ display: 'flex', alignItems: 'center' }}>
